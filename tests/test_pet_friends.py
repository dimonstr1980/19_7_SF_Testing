...
def test_get_all_my_pets_with_valid_key(filter='my_pets'):
    """ Проверка личного зоопарка, который может быть и пустым."""
...
def test_add_new_pet_with_valid_data(name='Чарли', animal_type='газель',
                                     age='2', pet_photo='images/deer.jpg'):
...
def test_add_new_pet_without_photo(name='Даффи', animal_type='утка', age=0):
...
def test_successful_update_self_pet_info(name='Даффи', animal_type='утка', age=1):
